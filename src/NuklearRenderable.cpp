...
namespace NuklearOgre
{
    ...
    NuklearRenderable::NuklearRenderable(Ogre::IdType id, Ogre::ObjectMemoryManager *objectMemoryManager,
    ...
    const Ogre::String& NuklearRenderable::getMovableType(void) const
	{
		return Ogre::BLANKSTRING;
	}

    const Ogre::LightList& NuklearRenderable::getLights(void) const
	{
		return this->queryLights(); //Return the data from our MovableObject base class.
	}

    void NuklearRenderable::getRenderOperation(Ogre::v1::RenderOperation& op, bool casterPass)
	{
	...
	void NuklearRenderable::getWorldTransforms(Ogre::Matrix4* xform) const
	{
		OGRE_EXCEPT(Ogre::Exception::ERR_NOT_IMPLEMENTED,
	...
	bool NuklearRenderable::getCastsShadows(void) const
	{
		OGRE_EXCEPT(Ogre::Exception::ERR_NOT_IMPLEMENTED,
